...
class RealTime
{
     ...
     * @param  array<int, string>|string  $tickers
     */
    public function limitUpLimitDown(array|string $tickers): string
    {
        return $this->channel('LULD', $tickers);
    }

    /**
     * @param  array<int, string>|string  $tickers
     */
    public function netOrderImbalance(array|string $tickers): string
    {
        return $this->channel('NOI', $tickers);
    }
