...
namespace Pjmarshall1\Massive\Resources\Crypto\Stream;
...
class RealTime
{
    ...
    {
        return $this->channel('XAS', $tickers);
    }
    ...
    {
        return $this->channel('XA', $tickers);
    }
    ...
    {
        return $this->channel('XT', $tickers);
    }
    ...
    {
        return $this->channel('XQ', $tickers);
    }
